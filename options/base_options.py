...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--stage1_dir', type=str, default='',
                            help='path to the directory that contains stage1_outputs')
        ...
        parser.add_argument('--stage', type=str, default='1', help='1|2')
        ...
        parser.add_argument('--netG', type=str, default='ADGANPP', help='selects model to use for netG (pix2pixhd | spade)')
        parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in first conv layer')
        parser.add_argument('--init_type', type=str, default='xavier', help='network initialization [normal|xavier|kaiming|orthogonal]')
        parser.add_argument('--init_variance', type=float, default=0.02, help='variance of the initialization distribution')
        parser.add_argument('--z_dim', type=int, default=256,
                            help="dimension of the latent z vector")
        parser.add_argument('--generator_mode', type=str, default='reconstruct', help='[reconstruct|transfer]')
        parser.add_argument("--part_idx", default=0,help="segmentation part index")
        parser.add_argument('--is_spade', type=bool, default=False, help='True|False')
        parser.add_argument('--add_sem_guidance', type=bool, default=False, help='True|False')
